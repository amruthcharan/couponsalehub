...
class HomeController extends Controller
{
    public function __invoke()
    {
        ...
        $top = Store::whereTopReview(true)->select('slug', 'feature_image', 'name')->latest('updated_at')->take(8)->get()->toArray();
        $popular = Store::wherePopularStore(true)->select('slug', 'logo', 'name')->latest('updated_at')->take(12)->get()->toArray();
